...
**Sentry (this user)**: https://couchers.sentry.io/issues/?project=5887585&query=user.id%3A1&statsPeriod=24h""".strip()
...
**Session replay**: https://couchers.sentry.io/replays/0123456789abcdef0123456789abcdef/?project=5887585""".strip()
